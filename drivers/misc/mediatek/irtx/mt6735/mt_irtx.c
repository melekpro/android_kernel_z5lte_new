...
#define IRTX_GPIO_EN_DEFAULT 2
#define IRTX_GPIO_EN_SET 3

char *irtx_gpio_cfg[] = { "irtx_gpio_default", "irtx_gpio_led_set", "irtx_en_set0", "irtx_en_set1"};
...
static int dev_char_open(struct inode *inode, struct file *file)
{
	...
	int clk_en_ret = 0;
#endif /* !defined(CONFIG_MTK_CLKMGR) */
    switch_irtx_gpio(IRTX_GPIO_EN_SET);
...
#endif /* !defined(CONFIG_MTK_CLKMGR) */
    switch_irtx_gpio(IRTX_GPIO_EN_DEFAULT);
	return 0;
}

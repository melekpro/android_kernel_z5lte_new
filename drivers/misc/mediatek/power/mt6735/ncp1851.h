...
#define CON13_VBUSILIM_MASK		    0x01
#define CON13_VBUSILIM_SHIFT		3 
...
//CON0
extern unsigned int ncp1851_get_chip_status(void);

extern unsigned int ncp1851_get_batfet(void);

extern unsigned int ncp1851_get_ntc(void);

extern unsigned int ncp1851_get_statint(void);

extern unsigned int ncp1851_get_faultint(void);


//CON1
extern void ncp1851_set_reset(unsigned int val);

extern void ncp1851_set_chg_en(unsigned int val);

extern void ncp1851_set_otg_en(unsigned int val);

extern unsigned int ncp1851_get_otg_en(void);

extern void ncp1851_set_ntc_en(unsigned int val);

extern void ncp1851_set_tj_warn_opt(unsigned int val);

extern void ncp1851_set_jeita_opt(unsigned int val);

extern void ncp1851_set_tchg_rst(unsigned int val);

extern void ncp1851_set_int_mask(unsigned int val);

//CON2
extern void ncp1851_set_wdto_dis(unsigned int val);

extern void ncp1851_set_chgto_dis(unsigned int val);

extern void ncp1851_set_pwr_path(unsigned int val);

extern void ncp1851_set_trans_en(unsigned int val);

extern void ncp1851_set_factory_mode(unsigned int val);

extern void ncp1851_set_iinset_pin_en(unsigned int val);

extern void ncp1851_set_iinlim_en(unsigned int val);

extern void ncp1851_set_aicl_en(unsigned int val);

#if 0//lisong 2014-8-19 [NO BUGID][fix bug:ncp1851 otg vbus overload]start
//CON6
extern unsigned int ncp1851_get_vbusilim(void);
#endif//lisong 2014-8-19 [NO BUGID][fix bug:ncp1851 otg vbus overload]end

//CON8
extern unsigned int ncp1851_get_vfet_ok(void);

#if 0//lisong 2014-8-19 [NO BUGID][fix bug:ncp1851 otg vbus overload]start
//CON13
extern void ncp1851_set_vbusilim_mask(unsigned int val);
#endif//lisong 2014-8-19 [NO BUGID][fix bug:ncp1851 otg vbus overload]end

//CON14
extern void ncp1851_set_ctrl_vbat(unsigned int val);

//CON15
extern void ncp1851_set_ieoc(unsigned int val);

extern void ncp1851_set_ichg(unsigned int val);
extern unsigned int  ncp1851_get_ichg(void);

//CON16
extern void ncp1851_set_iweak(unsigned int val);

extern void ncp1851_set_ctrl_vfet(unsigned int val);

extern void ncp1851_set_iinlim(unsigned int val);

//CON17
extern void ncp1851_set_vchred(unsigned int val);

extern void ncp1851_set_ichred(unsigned int val);

//CON18
extern void ncp1851_set_batcold(unsigned int val);

extern void ncp1851_set_bathot(unsigned int val);

extern void ncp1851_set_batchilly(unsigned int val);

extern void ncp1851_set_batwarm(unsigned int val);
...
#if 0//lisong 2014-8-19 [NO BUGID][fix bug:ncp1851 otg vbus overload]start
extern void ncp1851_int_enable(int enable);
#endif//lisong 2014-8-19 [NO BUGID][fix bug:ncp1851 otg vbus overload]end

...
/*----------------------------------------------------------------------------*/
/*----------------------------------------------------------------------------*/
int mmc3524x_gyroscope_operate(void *self, uint32_t command, void *buff_in, int size_in,
	void *buff_out, int size_out, int *actualout)
{
	int err = 0;
	int value;
	...
	if (atomic_read(&data->trace) & AMK_FUN_DEBUG)
		MMCFUNC("mmc3524x_gyroscope_operate");
#endif
...
/*----------------------------------------------------------------------------*/
int mmc3524x_rotation_vector_operate(void *self, uint32_t command, void *buff_in, int size_in,
	void *buff_out, int size_out, int *actualout)
{
	int err = 0;
	int value;
...
#if DEBUG
	if (atomic_read(&data->trace) & AMK_FUN_DEBUG)
		MMCFUNC("mmc3524x_rotation_vector_operate");
#endif
...
/*----------------------------------------------------------------------------*/
int mmc3524x_gravity_operate(void *self, uint32_t command, void *buff_in, int size_in,
	void *buff_out, int size_out, int *actualout)
{
	int err = 0;
	int value;
...
#if DEBUG
	if (atomic_read(&data->trace) & AMK_FUN_DEBUG)
		MMCFUNC("mmc3524x_gravity_operate");
#endif
...
/*----------------------------------------------------------------------------*/
int mmc3524x_linear_accelration_operate(void *self, uint32_t command, void *buff_in, int size_in,
	void *buff_out, int size_out, int *actualout)
{
	int err = 0;
	int value;
...
#if DEBUG
	if (atomic_read(&data->trace) & AMK_FUN_DEBUG)
		MMCFUNC("mmc3524x_linear_accelration_operate");
#endif

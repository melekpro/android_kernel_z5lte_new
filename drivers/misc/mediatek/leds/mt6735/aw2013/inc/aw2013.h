...
#define AW2013_RED_LED_BREATH_CURRENT				(1) //0-->0mA  1-->5mA  2-->10mA  3-->15mA
#define AW2013_GREEN_LED_BREATH_CURRENT			(1)
#define AW2013_BLUE_LED_BREATH_CURRENT			(1)

#define AW2013_RED_LED_CURRENT				(1) //0-->0mA  1-->5mA  2-->10mA  3-->15mA
#define AW2013_GREEN_LED_CURRENT			(1)
#define AW2013_BLUE_LED_CURRENT				(1)

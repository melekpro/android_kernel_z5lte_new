...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = SP5409_SENSOR_ID,
    
    .checksum_value = 0x84929886,        //checksum value for Camera Auto Test
...
write_cmos_sensor(0x10,0x00); //ÆØ¹âÊ±¼äµÍÓÚ10ms½øÈëoutdoor 
write_cmos_sensor(0x11,0xeb);
write_cmos_sensor(0x12,0x00); //ÆØ¹âÊ±¼ä¸ßÓÚ10ms,µÍÓÚ110ms½øÈënormalÌ¬
write_cmos_sensor(0x13,0xed);
write_cmos_sensor(0x14,0x0a); //ÆØ¹âÊ±¼ä¸ßÓÚ110ms,µÍÓÚ160ms£¬ÔöÒæ¸ßÓÚ4x½øÈëdummy
write_cmos_sensor(0x15,0x2f);
write_cmos_sensor(0x16,0x0e); //ÆØ¹âÊ±¼ä¸ßÓÚ160ms,ÔöÒæÎª6x½øÈëlowlight
...
write_cmos_sensor(0x93,0x00); //¹Ø±ÕgÍ¨µÀÆ½»¬
write_cmos_sensor(0xfd,0x01);

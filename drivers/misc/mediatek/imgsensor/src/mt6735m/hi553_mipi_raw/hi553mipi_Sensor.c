...
#include "hi553mipi_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "HI553_camera_sensor"
...
//#define HI553MIPI_I2C_ID  0x40
#define write_cmos_sensor(addr, para) iWriteReg((u16) addr , (u32) para , 2, 0x40)

static imgsensor_info_struct imgsensor_info = {
    	.sensor_id = HI553_SENSOR_ID,		//record sensor id defined in Kd_imgsensor.h
    ...
    .hs_video = {
        .pclk = 176000000,
        .linelength = 2816,				//record different mode's linelength
		.framelength = 704,			//record different mode's framelength
		.startx = 0,
		.starty = 0,
...
/*static void write_hi553_sensor(kal_uint32 addr, kal_uint32 para)
{
...
static kal_uint16 set_gain(kal_uint16 gain)
{
    ...
    LOG_INF("gain = %d , reg_gain = 0x%x\n ", gain, reg_gain);
     ...
     write_cmos_sensor(0x0046, 0x0100);
	write_cmos_sensor(0x003a,(reg_gain&0xff));   
	write_cmos_sensor(0x0046, 0x0000);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	LOG_INF("hi553 [get_imgsensor_id] ");
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
            ...
            *sensor_id = return_sensor_id();
                ...
                LOG_INF("hi553 i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
					return ERROR_NONE;
				}	
            LOG_INF("hi553 Read sensor id fail, write id: 0x%x, id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
				retry--;
			} while(retry > 0);
			i++;
			retry = 2;

...
#define S5K4H8YX_USE_AWB_OTP
#if defined(S5K4H8YX_USE_AWB_OTP)

#define RG_TYPICAL 0x242
#define BG_TYPICAL 0x21B


kal_uint32 tRG_Ratio_typical = RG_TYPICAL;
kal_uint32 tBG_Ratio_typical = BG_TYPICAL;

struct S5K4H8YX_MIPI_otp_struct{
	kal_uint32 R_to_G;
	kal_uint32 B_to_G;
	kal_uint32 G_to_G;
	kal_uint32 R_Gain;
...
kal_uint16 S5K4H8YX_MIPI_read_otp_wb(struct S5K4H8YX_MIPI_otp_struct *otp)
{
	kal_uint32 val,val1,val2;
	kal_uint32 B_to_G=0;
	kal_uint32 R_to_G=0;
...
//	{
	PageCount = 0x0f;
	awbflag = 0x00;
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] PageCount=%d\n", PageCount);	
	write_cmos_sensor_8(0x0a02, PageCount); //page set
	
	
	write_cmos_sensor_8(0x0a00, 0x01); //otp enable read
	mdelay(10);
	LOG_INF("2S5K4H8YX_MIPI_read_otp_wb group1 module id=%d\n",read_cmos_sensor_8(0x0a05));
	LOG_INF("2S5K4H8YX_MIPI_read_otp_wb group2 module id=%d\n",read_cmos_sensor_8(0x0a09));
	//LOG_INF("S5K4H8YX_MIPI_read_otp_wb 0x0a02=%d\n",read_cmos_sensor_8(0x0a02)>>8);
	//LOG_INF("S5K4H8YX_MIPI_read_otp_wb 0x0a0e=%d\n",read_cmos_sensor_8(0x0a0e)>>8);
	//LOG_INF("S5K4H8YX_MIPI_read_otp_wb 0x0a0f=%d\n",read_cmos_sensor_8(0x0a0f)>>8);
	//LOG_INF("S5K4H8YX_MIPI_read_otp_wb 0x0a10=%d\n",read_cmos_sensor_8(0x0a10)>>8);
	LOG_INF("--------------------------------------------\n");
	LOG_INF("S5K4H8YX_MIPI_read_otp_wb 0x0a02=%d\n",read_cmos_sensor_8(0x0a02));
	LOG_INF("S5K4H8YX_MIPI_read_otp_wb 0x0a0e=%d\n",read_cmos_sensor_8(0x0a0e));
	LOG_INF("S5K4H8YX_MIPI_read_otp_wb 0x0a0f=%d\n",read_cmos_sensor_8(0x0a0f));
	LOG_INF("S5K4H8YX_MIPI_read_otp_wb 0x0a10=%d\n",read_cmos_sensor_8(0x0a10));	
	
	awbflag = read_cmos_sensor_8(0x0a0d);
	LOG_INF("S5K4H8YX_MIPI_read_otp_wb awbflag=%d\n",awbflag);
	write_cmos_sensor_8(0x0a00, 0x00); //otp disable read
		
	if(awbflag == 0x40){
		write_cmos_sensor_8(0x0a02, PageCount); //page set
		write_cmos_sensor_8(0x0a00, 0x01); //otp enable read	
		mdelay(10);
		val = read_cmos_sensor_8(0x0a10);
		val1 = read_cmos_sensor_8(0x0a0e);
		val2 = read_cmos_sensor_8(0x0a0f);
		R_to_G = (val1<<2)+((val>>6)&0x03);
		B_to_G = (val2<<2)+((val>>4)&0x03);
		LOG_INF("2S5K4H8YX_MIPI_read_otp_wb 0x0a02=%d\n",read_cmos_sensor_8(0x0a02));
		LOG_INF("2S5K4H8YX_MIPI_read_otp_wb 0x0a0e=%d\n",read_cmos_sensor_8(0x0a0e));
		LOG_INF("2S5K4H8YX_MIPI_read_otp_wb 0x0a0f=%d\n",read_cmos_sensor_8(0x0a0f));
		LOG_INF("2S5K4H8YX_MIPI_read_otp_wb 0x0a10=%d\n",read_cmos_sensor_8(0x0a10));
//		G_to_G = (read_cmos_sensor(0x3a0d)<<8)+read_cmos_sensor(0x3a0e);
		write_cmos_sensor_8(0x0a00, 0x00); //otp disable read
	}
	else if(awbflag == 0xd0){
		write_cmos_sensor_8(0x0a02, PageCount); //page set
		write_cmos_sensor_8(0x0a00, 0x01); //otp enable read
		mdelay(10);
		val = read_cmos_sensor_8(0x0a13);
		val1 = read_cmos_sensor_8(0x0a11);
		val2 = read_cmos_sensor_8(0x0a12);
		R_to_G = (val1<<2)+((val>>6)&0x03);
		B_to_G = (val2<<2)+((val>>4)&0x03);
		LOG_INF("2S5K4H8YX_MIPI_read_otp_wb 0x0a02=%d\n",read_cmos_sensor_8(0x0a02));
		LOG_INF("2S5K4H8YX_MIPI_read_otp_wb 0x0a11=%d\n",read_cmos_sensor_8(0x0a11));
		LOG_INF("2S5K4H8YX_MIPI_read_otp_wb 0x0a12=%d\n",read_cmos_sensor_8(0x0a12));
		LOG_INF("2S5K4H8YX_MIPI_read_otp_wb 0x0a13=%d\n",read_cmos_sensor_8(0x0a13));
//		G_to_G = (read_cmos_sensor(0x3a0d)<<8)+read_cmos_sensor(0x3a0e);
		write_cmos_sensor_8(0x0a00, 0x00); //otp disable read
	}
		if((R_to_G == 0) || (B_to_G == 0))
			return -1;

//		if(PageCount == 1)
//			LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] otp all value is zero");
//	}

	otp->R_to_G = R_to_G;
	otp->B_to_G = B_to_G;
//	otp->G_to_G = 0x400;
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] otp->R_to_G=0x%x\n", otp->R_to_G);	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] otp->B_to_G=0x%x\n", otp->B_to_G);	
//	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] otp->G_to_G=0x%x\n", otp->G_to_G);	
	return 0;
}

kal_uint16 S5K4H8YX_MIPI_algorithm_otp_wb(struct S5K4H8YX_MIPI_otp_struct *otp)
{
	...
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] R_to_G=%d\n", R_to_G);	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] B_to_G=%d\n", B_to_G);	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] G_to_G=%d\n", G_to_G);	
	...
	temp = R_to_G * 100 / G_to_G;
	R_Gain =  75 * 256 / temp ;
	
	temp = B_to_G * 100 / G_to_G;
	B_Gain =  70 * 256 / temp ;
	...
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] R_gain=0x%x\n", otp->R_Gain);	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] B_gain=0x%x\n", otp->B_Gain);	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] G_gain=0x%x\n", otp->G_Gain);
	return 0;
}

kal_uint16 S5K4H8YX_MIPI_algorithm_otp_wb1(struct S5K4H8YX_MIPI_otp_struct *otp)
{
	kal_uint32 R_to_G, B_to_G, G_to_G;
...
kal_uint16 S5K4H8YX_MIPI_write_otp_wb(struct S5K4H8YX_MIPI_otp_struct *otp)
{
	...
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] R_GainH=0x%x\n", R_GainH);	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] R_GainL=0x%x\n", R_GainL);	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] B_GainH=0x%x\n", B_GainH);
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] B_GainL=0x%x\n", B_GainL);	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] G_GainH=0x%x\n", G_GainH);	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] G_GainL=0x%x\n", G_GainL);

	write_cmos_sensor_8(0x020e, G_GainH);
	write_cmos_sensor_8(0x020f, G_GainL);
	write_cmos_sensor_8(0x0210, R_GainH);
	write_cmos_sensor_8(0x0211, R_GainL);
	write_cmos_sensor_8(0x0212, B_GainH);
	write_cmos_sensor_8(0x0213, B_GainL);
	write_cmos_sensor_8(0x0214, G_GainH);
	write_cmos_sensor_8(0x0215, G_GainL);

	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] [0x020e,0x%x]\n", read_cmos_sensor_8(0x020e));	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] [0x020f,0x%x]\n", read_cmos_sensor_8(0x020f));	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] [0x0210,0x%x]\n", read_cmos_sensor_8(0x0210));
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] [0x0211,0x%x]\n", read_cmos_sensor_8(0x0211));	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] [0x0212,0x%x]\n", read_cmos_sensor_8(0x0212));	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] [0x0213,0x%x]\n", read_cmos_sensor_8(0x0213));
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] [0x0214,0x%x]\n", read_cmos_sensor_8(0x0214));	
	LOG_INF("[S5K4H8YX] [S5K4H8YX_MIPI_read_otp_wb] [0x0215,0x%x]\n", read_cmos_sensor_8(0x0215));
	return 0;
}

kal_uint16 S5K4H8YX_MIPI_update_wb_register_from_otp(void)
{
	
	struct S5K4H8YX_MIPI_otp_struct current_otp;
	S5K4H8YX_MIPI_read_otp_wb(&current_otp);
	//S5K4H8YX_MIPI_algorithm_otp_wb(&current_otp);
	S5K4H8YX_MIPI_algorithm_otp_wb1(&current_otp);
	S5K4H8YX_MIPI_write_otp_wb(&current_otp);
	return 0;
}
#endif
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
		#ifdef S5K4H8YX_USE_AWB_OTP
		S5K4H8YX_MIPI_update_wb_register_from_otp();
		#endif
	return ERROR_NONE;
}	/*	open  */

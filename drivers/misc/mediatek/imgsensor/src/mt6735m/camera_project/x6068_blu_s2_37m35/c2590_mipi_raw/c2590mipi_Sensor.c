...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0x153df416,        //checksum value for Camera Auto Test-ffd8e112

    .pre = {
        .pclk = 52800000,                //record different mode's pclk
...
static imgsensor_struct imgsensor = {
    ...
    .min_frame_length = 1714,//add zsf cista
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x0307,0x58);   //47 for 20fps    

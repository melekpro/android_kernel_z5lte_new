...
char wtk_mem_name[100]= {0};
static int __init init_wtk_mem_name(char *str)
{
       strncpy(wtk_mem_name, str, sizeof(wtk_mem_name)-1);
       wtk_mem_name[sizeof(wtk_mem_name)-1] = '\0';
       return 1;
}
...
static const struct file_operations wtk_mem_info_proc_fops = { 
       .owner      = THIS_MODULE,
...
int wtk_creat_proc_mem_info(void)
{
       struct proc_dir_entry *mem_info_entry = proc_create("wtk_memInfo", 0444, NULL, &wtk_mem_info_proc_fops);

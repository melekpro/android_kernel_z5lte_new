...
#if 1//lisong 2016-4-26 [BUGID:NULL][get lcm adc value]start
static ssize_t show_AUXADC_Lcm_id(struct device *dev, struct device_attribute *attr,
					     char *buf)
{
	int rawdata = 0;
	int lcm_vol = 0;
...
static ssize_t store_AUXADC_Lcm_id(struct device *dev, struct device_attribute *attr,
					      const char *buf, size_t size)
{
	return size;
}

static DEVICE_ATTR(AUXADC_Lcm_id, 0664, show_AUXADC_Lcm_id,
		   store_AUXADC_Lcm_id);

#endif//lisong 2016-4-26 [BUGID:NULL][get lcm adc value]end
/* ///////////////////////////////////////////////////////////////////////////////////////// */
...
#endif
#if 1//lisong 2016-4-26 [BUGID:NULL][get lcm adc value]start
	ret = device_create_file(dev, &dev_attr_AUXADC_Lcm_id);
	if (ret != 0)
		goto exit;
#endif//lisong 2016-4-26 [BUGID:NULL][get lcm adc value]end

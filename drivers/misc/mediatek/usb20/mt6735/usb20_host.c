...
#if 1//lisong 2013-10-30 [NO BUGID][set default otg drvvbus pin state:low]start
extern void ncp1854_int_enable(int enable);
#endif//lisong 2013-10-30 [NO BUGID][set default otg drvvbus pin state:low]end

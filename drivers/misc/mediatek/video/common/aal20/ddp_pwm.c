...
#if 1//lisong 2016-7-5[BUGID:NULL][lcm current consumption is too high]start
static unsigned int brightness_div(unsigned int level_1024,unsigned int percent)
{
    return ((unsigned int)((level_1024*percent)/100));
}
#endif//lisong 2016-7-5[BUGID:NULL][lcm current consumption is too high]end

/* For backward compatible */
int disp_bls_set_backlight(int level_1024)
{
    #if 1//lisong 2016-7-5[BUGID:NULL][lcm current consumption is too high]start
    //printk("[wtk_log1]level_1024=%d\n",level_1024);
    level_1024 = (int)brightness_div(level_1024, 90);
    //printk("[wtk_log2]level_1024=%d\n",level_1024);
    #endif//lisong 2016-7-5[BUGID:NULL][lcm current consumption is too high]end

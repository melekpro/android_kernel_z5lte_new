...
static int KXTJ2_1009_SetDataResolution(struct kxtj2_1009_i2c_data *obj)
{
	...
	err = hwmsen_read_block(obj->client, KXTJ2_1009_REG_DATA_RESOLUTION, databuf, 0x01);
	if(err)
	{
...
static ssize_t show_power_status_value(struct device_driver *ddri, char *buf)
{
	...
	u8 addr = KXTJ2_1009_REG_POWER_CTL;
	int err = 0;
	err = hwmsen_read_block(kxtj2_1009_i2c_client, addr, databuf, 0x01);
	if(err)
	{
		GSE_ERR("read power ctl register err!\n");
		return KXTJ2_1009_ERR_I2C;
...
static struct driver_attribute *kxtj2_1009_attr_list[] = {
	...
	&driver_attr_i2c,
	&driver_attr_direction,//add by yangjuwei

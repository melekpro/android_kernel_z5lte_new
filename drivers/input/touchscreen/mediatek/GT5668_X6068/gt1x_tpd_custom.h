...
#define key_1           60,1500
#define key_2           180,1500
#define key_3           300,1500
#define TPD_KEY_MAP_ARRAY {{key_1},{key_2},{key_3}}
#define TPD_KEYS        {KEY_MENU, KEY_HOMEPAGE, KEY_BACK}
#define TPD_KEYS_DIM    {{key_1,50,20},{key_2,50,20},{key_3,50,20}}
#endif

#define RGK_SAMPLE_VERSION		0x000119
/*****************************add for 9375 info start***********************************/
#define MODULE_MAX_LEN 		40
#define TEMEIKE_SENSOR_ID				2
#define HELITAI_SENSOR_ID				1
#define HELITAI_S3_SENSOR_ID			0
#define LONGFEI_SENSOR_ID				3

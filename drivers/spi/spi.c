...
static const struct file_operations wtk_finger_info_proc_fops = {	
	.owner      = THIS_MODULE,
...
{
	struct proc_dir_entry *finger_info_entry = proc_create("wtk_fingerInfo", 0444, NULL, &wtk_finger_info_proc_fops);
	if (finger_info_entry == NULL)
